...
(function(window, undefined) {
      ...
      parsers: {
        ...
        entities: {
          ...
          call: function() {
            ...
            if (name) {
              return new(tree.Call)(name, args, index, env.filename, env.rootpath)
            }
          },
          arguments: function() {
            var args = [],
  ...
  (function(tree) {
    ...
    var parseCopyProperties = ['paths', // paths to search for imports on
