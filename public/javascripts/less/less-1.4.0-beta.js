        ...
        return parser = {
            ...
            parsers: {
                ...
                primary: function() {
                    ...
                    while ((node = $(this.extendRule) || $(this.mixin.definition) || $(this.rule) || $(this.ruleset) || $(this.mixin.call) || $(this.comment) || $(this.directive)) || $(/^[\s\n]+/) || $(/^;+/)) {
                        node && root.push(node);
                    }
                    return root;
                },
                ...
                entities: {
                    ...
                    literal: function() {
                        return $(this.entities.dimension) || $(this.entities.color) || $(this.entities.quoted) || $(this.entities.unicodeDescriptor);
                    },
                ...
                mixin: {
                    ...
                    args: function(isCall) {
                        var expressions = [],
                            argsSemiColon = [],
                            isSemiColonSeperated, argsComma = [],
                            expressionContainsNamed, name, nameLoop, value, arg,
                            returner = {
                                args: null,
                                variadic: false
                            };
                ...
                rule: function(tryAnonymous) {
                    ...
                    if (name = $(this.variable) || $(this.property)) {
                        ...
                        value = !tryAnonymous && (env.compress || (name.charAt(0) === '@')) ? ($(this.value) || $(this.anonymousValue)) : ($(this.anonymousValue) || $(this.value));
                ...
                addition: function() {
                    ...
                    if (m = $(this.multiplication)) {
                        isSpaced = isWhitespace(input.charAt(i - 1));
                        while ((op = $(/^[-+]\s+/) || (!isSpaced && ($('+') || $('-')))) && (a = $(this.multiplication))) {
                            m.parensInOp = true;
                            a.parensInOp = true;
                            operation = new(tree.Operation)(op, [operation || m, a], isSpaced);
                            isSpaced = isWhitespace(input.charAt(i - 1));
    ...
    (function(tree) {
        ...
        tree.mixin.Definition.prototype = {
            ...
            eval: function(env, args, important) {
                ...
                ruleset = new(tree.Ruleset)(null, rules).eval(new(tree.evalEnv)(env, [this, frame].concat(mixinFrames)));
            ...
            matchCondition: function(args, env) {
                ...
                new(tree.evalEnv)(env, [this.evalParams(env, new(tree.evalEnv)(env, this.frames.concat(env.frames)), args, [])].concat(env.frames)))) {
                    return false;
                }
                return true;
            },
        ...
        tree.processExtendsVisitor.prototype = {
            ...
            doExtendChaining: function(extendsList, extendsListTarget, iterationCount) {
                ...
                var extendIndex, targetExtendIndex, matches, extendsToAdd = [],
                    ...
                    selectorPath, extend, targetExtend;
            ...
            extendSelector: function(matches, selectorPath, replacementSelector) {
                ...
                for (matchIndex = 0; matchIndex < matches.length; matchIndex++) {
                    ...
                    selector.elements.slice(currentSelectorPathElementIndex, match.index)
                        .concat([firstElement])
